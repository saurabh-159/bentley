...
const navItemClass =
  "relative h-12 rounded-none bg-transparent px-3.5 text-[15px] font-medium tracking-wide text-foreground/70 hover:bg-transparent hover:text-foreground focus:bg-transparent data-popup-open:bg-transparent data-popup-open:text-foreground data-open:bg-transparent data-open:text-foreground";
